$(function () {
    ...
    $(".submit").click(function () {
        ...
        $(".purse").each(function () {
            ...
            var amount = $(".origin-amount", this).val();
    ...
    $(".adjust_num").on("keyup change", function () {

        var row = $(this).parents(".purse");
        var num = parseInt($(this).val());
        var amount = row.find(".amount > f");
        var origin_amount = row.find(".origin-amount").val();

        if (isNaN(num)) {
            amount.html(origin_amount);
            return false;
        }

        amount.html(parseInt(origin_amount) + num);
