		...
		<table class="table">
			...
			<?php foreach($floors as $floor) {?>
				<tr data-uid="<?=$floor["id"]?>" class="floor">
					...
					<td><?=$floor["id"]?></td>
					<td><input type="text" value="<?=$floor["name"]?>" class="floor-name form-control" placeholder="輸入名稱"></td>
					<td><input type="checkbox" class="floor-open" <?=(int)$floor["open"]?"checked":""?>></td>
				</tr>
			<?php } ?>
			</tbody>
		</table>
